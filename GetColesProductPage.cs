...
{
    public interface IGetColesProductPageFunction
    {
        Task<HttpResponseData> Run(HttpRequestData req, FunctionContext executionContext);
    }

    public class GetColesProductPageFunction : IGetColesProductPageFunction
    {
        ...
        public GetColesProductPageFunction(ILoggerFactory loggerFactory)
        {
            _logger = loggerFactory.CreateLogger<GetColesProductPageFunction>();
        }

        [Function("GetColesProductPage")]
        ...
        [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(ColesProductResponsePage), Description = "The OK response")]
            ...
            FunctionContext executionContext)
        {
            ...
            ColesProductResponsePage productPage;
            try
            {
            ...
            {
                _logger.LogError($"Error crawling Coles product page: {ex.Message}");
        ...
        private static async Task<ColesProductResponsePage?> GetProductPageAsync(int offset)
        {
